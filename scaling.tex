...
We hypothesize that probabilistic methods are not as performant neural methods because they have
neither been scaled to similar sizes as their modern neural counterparts nor taken advantage of 
modern parallel hardware.
A significant barrier to scaling in probabilistic methods is inference,
...
We parameterize the feature map $\phi(\bu) = W_\phi\bu$,
