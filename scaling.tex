...
Kernel belief propagation (KBP), as well as the line of research that uses kernel mean embeddings,
...
While KBP focuses on using the kernel matrix representation for nonparametric inference,
